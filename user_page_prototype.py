...
report_lost_btn = Button(button_frame, text="Report Lost Item", width=18, height=2, font=("Arial", 12, "bold"), bg="#ff2f00", fg="white", relief="flat", cursor="hand2",command=report_lost_item)
